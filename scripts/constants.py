...
IMPUTE_VALUE = "mean"
SCALING = "standardize"
REST_URL = "http://158.195.68.76:5002"
SD_DEFAULT = 0
...
DBNSFP_GENE_ATTRIBUTES = [
    ...
    # -------------------------------------------------------------
       ...
       'MIM_disease', 'Orphanet_disorder_id', 'Orphanet_disorder',
       'Orphanet_association_type', 'Trait_association(GWAS)',
    ...
    # -------------------------------------------------------------
       ...
       'Essential_gene_gene-trap', 'Gene_indispensability_score',
...
DBNSFP_CATEGORICAL = np.setdiff1d(DBNSFP_GENE_ATTRIBUTES_MODELLING, DBNSFP_NUMERICAL)
